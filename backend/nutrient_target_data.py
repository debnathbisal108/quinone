...
# =========================================================================
#
# The supplied research contains adult summary values for these nutrients,
# but it does not contain a complete age-, pregnancy-, and lactation-resolved
# lookup table.
#
# These records are retained so the engine knows the canonical nutrient keys
# and adult reference values. The resolver must not apply these adult values
# to children, pregnancy, or lactation.
# =========================================================================
